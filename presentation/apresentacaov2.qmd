...
Reformulamos toda a classe `Stock` para que ela comporte a nova estrutura de dados de árvore incluindo novas funcionalidades, além das já existentes de adicionar, remover, atualizar e listar os produtos do estoque.

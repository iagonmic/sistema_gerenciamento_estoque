...
- Foi utilizado também a linguagem Quarto (.qmd) junto de seu plugin no VS Code para produção dos slides e do guia.
...
É a maior classe, contendo as funções principais do programa
